  ...
  return (
    <div className="p-8 w-full">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
        ...
        <div className="bg-white sketch-border sketch-shadow p-6 lg:col-span-2 fade-up" style={{ animationDelay: "540ms" }}>
          <h3 className="font-hand-display text-[22px] font-bold text-ink-secondary marker-underline inline-block">
            分类分布
          </h3>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
        ...
        <div className="bg-white sketch-border sketch-shadow p-6 lg:col-span-2 fade-up" style={{ animationDelay: "660ms" }}>
          <h3 className="font-hand-display text-[22px] font-bold text-ink-secondary marker-underline inline-block">
            热门文章
          </h3>
